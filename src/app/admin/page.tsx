            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{loading ? '...' : stats.adminUsers}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{loading ? '...' : stats.regularUsers}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Recent Audit Logs</dt>
                  <dd className="text-lg font-medium text-gray-900">{loading ? '...' : stats.recentAuditLogs}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 flex-1">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Manage user accounts, roles, and permissions. View, edit, and delete user accounts.
                </p>
                <div className="mt-3">
                  <Link
                    href="/admin/users"
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span>System audit logging is active and monitoring all admin actions</span>
              </div>
              <div className="flex items-center text-sm text-gray-600">
                <div className="flex-shrink-0 w-2 h-2 bg-blue-400 rounded-full mr-3"></div>
                <span>User management interface is ready for role updates and user administration</span>
              </div>
              <div className="flex items-center text-sm text-gray-600">
                <div className="flex-shrink-0 w-2 h-2 bg-purple-400 rounded-full mr-3"></div>
                <span>Audit log viewer provides comprehensive filtering and search capabilities</span>
              </div>
            </div>
          </div>
        </div>
